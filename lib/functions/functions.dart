...
//base url
String url =
    'http://35.158.95.58/admin/public/'; //please add '/' at end of the url as 'yourwebsite.com/'
String mqttUrl = '35.158.95.58'; //enter only ip address as 12.345.678.90
int mqttPort = 1883;
String mapkey = 'AIzaSyCgAtgTb8Fw-hf7wtSprJeq9G01LqqRA14';
String mapStyle = '';
